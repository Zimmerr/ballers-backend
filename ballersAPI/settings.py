"""
Django settings for ballersAPI project.
...
SECRET_KEY = 'django-insecure-73%@q9o@6ci=8h1k7f#^a3eb*ps^u6lj24007x2b4urjhf6xfp'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['ballers-api-6dbf058d4188.herokuapp.com', 'localhost']
...
WSGI_APPLICATION = 'ballersAPI.wsgi.application'
...
# CSRF settings
CSRF_TRUSTED_ORIGINS = ['https://zimmerr.github.io']
